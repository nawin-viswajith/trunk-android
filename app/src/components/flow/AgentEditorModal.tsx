          ...
          messages: [
            {
              role: "system",
              content:
                "You write effective system prompts for AI agents using the COSTAR framework: Context (background the agent needs to know), Objective (the task it must accomplish), Style (how it should write — structure, level of detail), Tone (its attitude, e.g. formal, friendly, concise), Audience (who its output is for), and Response format (the expected shape/length of its replies). Structure the system prompt with those six labeled sections, each filled in briefly and concretely for the given purpose. Output only the system prompt text itself — no preamble, no quotes, no explanation.",
            },
