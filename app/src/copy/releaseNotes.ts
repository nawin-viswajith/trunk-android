...
export const RELEASE_NOTES: ReleaseNote[] = [
  { version: "1.3.7b", summary: "Fixed math formulas rendering as blank boxes (now falls back to raw LaTeX with a Show raw/rendered toggle if rendering fails). Fixed Mermaid flowcharts not rendering when a node label wrapped across multiple lines." },
